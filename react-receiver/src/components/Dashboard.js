...
function Dashboard() {
	...
	function getEmployee() {
        axios.get('/api/v1/employee/'+localStorage.getItem('auth_employee'))
        .then(function (response) {
            // handle success
            let emp = response.data.data[0];
	...
	if(superadmin){
		return (<div>
				<div className="container">
					<h1 className="mt-4">SuperAdmin</h1>
					<ol className="breadcrumb mb-4">
						<li className="breadcrumb-item active">No Employee Details</li>
					</ol>
						...
						<div className="card-body">
							...
							{employee.username&&
								...
								<div className="row mb-3">
									...
									<div className="col-sm-9 text-secondary">
									{employee.username}
										{/* <input type="text" className="form-control" value={employee.username}/> */}
									</div>
								</div>
								<div className="row mb-3">
									<div className="col-sm-3">
							...
							<div className="row mb-3">
								...
								<div className="col-sm-9 text-secondary">
								{employee.contact}
									{/* <input type="text" className="form-control" value={employee.contact}/> */}
								</div>
							</div>
							<div className="row mb-3">
								<div className="col-sm-3">
								...
								<div className="col-sm-9 text-secondary">
								{employee.department}
									{/* <input type="text" className="form-control" value={employee.department}/> */}
								</div>
							</div>
							{/* <div className="row">
